...
//            Log.e("tag " , "result "  + trimdedResult);
//            try {
//                JSONObject json = new JSONObject(trimdedResult);
//                // 배열의 크기만큼 반복하면서, name과 address의 값을 추출함
//                // name과 address의 값을 추출함
//                 latitude = json.getString("latitude");
//                 longitude = json.getString("longitude");
//                Log.e("tag" ,"test" +latitude+longitude);
//            }catch(Exception e){
//                e.printStackTrace();
//            }
////            int idx = result.indexOf("&");
//            // @ 앞부분을 추출
//            String mail1 = drimdedResult .substring(0, idx-1);
//            // 뒷부분을 추출
//            String mail2 = drimdedResult .substring(idx);
//            Log.e("mail1" , "니가문제다" + Double.parseDouble(mail1));
